...
export default function UnsignedNavigation() {
      ...
      >
        ...
        <ol className="list-none p-3 space-y-3">
          <div className='p-4 rounded-md bg-gray-300'>
            <h1>Kami tidak bisa mengenali kamu!, silahkan <a href="/register" className='border-b-2 border-yellow-500 text-yellow-500'>daftar</a> atau <a href="/login" className='border-b-2 border-yellow-500 text-yellow-500'>login</a> terlebih dahulu.</h1>
          </div>
        </ol>
      </div>
    </>
